...
export function RecipientNotSameContractModal({
  isOpen,
  close,
  onConfirm,
}: {
  ...
  return (
    ...
    >
      <p className="text-center text-sm">
        The recipient address is the same as the connected wallet, but it appears to not exist as
        the same smart contract on the destination chain. Is this address correct?
      </p>
